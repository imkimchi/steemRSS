...
var methodMap = {
    'feed': function feed() {
        return _steem2.default.api.getDiscussionsByFeed(query);
    },
    'blog': function blog() {
        return _steem2.default.api.getDiscussionsByBlog(query);
    },
    'new': function _new() {
        return _steem2.default.api.getDiscussionsByCreated(query);
    },
    'hot': function hot() {
        return _steem2.default.api.getDiscussionsByHot(query);
    },
    'trend': function trend() {
        return _steem2.default.api.getDiscussionsByTrending(query);
    }
};
